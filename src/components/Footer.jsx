...
export const Footer = () => {
    ...
    return (
        <footer id="footer" className="bg-gray-light dark:bg-dark-footer-bg w-full p-8 lg:py-16 lg:px-32">
            <h2 className="font-bold text-black-heading dark:text-bluish-gray text-left text-4xl max-w-md">{apiResponse?.footer.contactHeader}</h2>
            <div className="flex flex-col lg:flex-row pt-16 pb-8">
                ...
                <nav className="flex items-center space-x-4 lg:space-x-8 ml-auto">
                    <a href="#" className='text-black-heading dark:text-dark-mode-hire'>{apiResponse?.footer.personalBlogLabel}</a>
