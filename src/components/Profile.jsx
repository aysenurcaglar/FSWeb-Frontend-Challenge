        ...
        <div className="px-8 text-left lg:px-32">
            ...
            <div className="flex flex-col gap-x-4 lg:gap-x-8 lg:flex-row">
                <div className="pb-8 lg:pb-16">
                    <h3 className="text-dark-purple dark:text-dark-mode-name text-2xl font-medium">Basic Information</h3>
                    <div className="flex flex-row place-content-between">
                        ...
                        <div className="max-w-xs flex flex-col text-black-heading dark:text-white mr-4 lg:mr-8">
                            ...
                            <p className="my-4">Hacettepe Unv. Bachelor's degree in Biology, 2016</p>
                ...
                <div className="max-w-lg pb-8 lg:pb-16">
                    ...
                    <p className="text-gray dark:text-white mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veniam aut, odit laborum aliquam voluptatum nisi mollitia.</p>
