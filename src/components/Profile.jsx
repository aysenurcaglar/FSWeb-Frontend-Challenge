        ...
        <div className="px-8 text-left lg:px-32">
            ...
            <div className="flex flex-col gap-x-4 lg:gap-x-8 lg:flex-row">
                <div className="pb-8 lg:pb-16">
                    ...
                    <div className="flex flex-row place-content-between">
                        <div className="max-w-xs flex flex-col text-black-heading dark:text-white font-bold mr-4 lg:mr-8">
                            <p className="my-4">{apiProfile?.basicInformation.items[0].label}</p>
                            <p className="my-4">{apiProfile?.basicInformation.items[1].label}</p>
                            <p className="my-4">{apiProfile?.basicInformation.items[2].label}</p>
                            <p className="my-4">{apiProfile?.basicInformation.items[3].label}</p>
                        </div>
                        <div className="max-w-xs flex flex-col text-black-heading dark:text-white mr-4 lg:mr-8">
                            <p className="my-4">{apiProfile?.basicInformation.items[0].value}</p>
                            <p className="my-4">{apiProfile?.basicInformation.items[1].value}</p>
                            <p className="my-4">{apiProfile?.basicInformation.items[2].value}</p>
                            <p className="my-4">{apiProfile?.basicInformation.items[3].value}</p>
                        </div>
                    </div>
                </div>
                <div className="max-w-lg pb-8 lg:pb-16">
                    ...
                    <p className="text-gray dark:text-white mb-4">{apiProfile?.aboutMe.paragraphs[0]}</p>
                    <p className="text-gray dark:text-white">{apiProfile?.aboutMe.paragraphs[1]}</p>
                </div>
            </div>
