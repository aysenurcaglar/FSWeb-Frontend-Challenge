        ...
        <div className="p-8 flex flex-col lg:flex-row gap-x-8 lg:gap-x-16 lg:py-16 lg:px-32 place-content-between">
            <div className="text-left">
                ...
                <nav className="flex flex-wrap place-content-evenly lg:place-content-between mt-8">
                    <a href="#" onClick={() => { footer.scrollIntoView({ behavior: "smooth" }) }} className={'text-white bg-navy-blue m-2 lg:m-0 h-14 pt-4 px-6 lg:pl-10 w-30 lg:w-36 border border-navy-blue rounded-md dark:text-black-heading dark:bg-dark-mode-hire'}>Hire me</a>
